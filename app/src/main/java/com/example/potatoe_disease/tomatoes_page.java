...
public class tomatoes_page extends AppCompatActivity {
    ...
    private String[] classNames = {"Blight", "Healthy"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tomatoes_page);
        ...
        cassavaButton.setOnClickListener(new View.OnClickListener() {
            ...
            private void goToNextActivity() {
                Intent intent = new Intent(tomatoes_page.this, MainActivity.class);
        ...
        captureButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(tomatoes_page.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                    captureImage();
                } else {
                    ActivityCompat.requestPermissions(tomatoes_page.this, new String[]{android.Manifest.permission.CAMERA}, CAMERA_PERMISSION_REQUEST_CODE);
                }
            }
        });
        ...
        galleryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(tomatoes_page.this, android.Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    selectFromGallery();
                } else {
                    ActivityCompat.requestPermissions(tomatoes_page.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, GALLERY_PERMISSION_REQUEST_CODE);
                }
            }
        });
    ...
    private ByteBuffer loadModelFile() throws IOException {
        InputStream inputStream = getAssets().open("tomatoes_augmented_two_classes.tflite");
    ...
    private void selectFromGallery() {
        if (ContextCompat.checkSelfPermission(tomatoes_page.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            openGallery();
        } else {
            ActivityCompat.requestPermissions(tomatoes_page.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, GALLERY_PERMISSION_REQUEST_CODE);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_PERMISSION_REQUEST_CODE && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(tomatoes_page.this, "Permission denied", Toast.LENGTH_SHORT).show();
        }
    }
