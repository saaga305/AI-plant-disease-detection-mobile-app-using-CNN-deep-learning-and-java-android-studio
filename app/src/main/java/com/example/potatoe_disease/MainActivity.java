...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tomatoesButton = findViewById(R.id.tomatoesButton);
        ...
        tomatoesButton.setOnClickListener(new View.OnClickListener() {
            ...
            private void goToNextActivity() {
                Intent intent = new Intent(MainActivity.this, tomatoes_page.class);
    ...
    private ByteBuffer loadModelFile() throws IOException {
        InputStream inputStream = getAssets().open("cassava_code_two_classes.tflite");
    ...
    public void onTomatoesButtonClick(View view) {
        // Create an Intent to navigate to your desired activity
        Intent intent = new Intent(this, tomatoes_page.class);
